...
When :var:`config.developer` is True, pressing camera_viewer (by default,
"shift+M"), will open Camera Viewer. This allow you to adjustment a camera
and layers positions by bars and manual inputs and see the result at the
moment.
